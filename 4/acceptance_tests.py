...
class AcceptanceTests(unittest.TestCase):
    ...
    def add_test(cls, dirpath, filename):
        ...
        def test_func(self):
            os.system("python main.py interpreterTests/{0} > interpreterTests/{1}.actual".format(filename,name))
            res = filecmp.cmp("interpreterTests/{0}.actual".format(name), "interpreterTests/{0}.expected".format(name))
...
if __name__ == '__main__':
    AcceptanceTests.add_tests('interpreterTests/')
    unittest.main()